...
```yaml
external_components:
  - source: github://darrenweake/esphome-sensowash@v1.0
...
- **If you DON'T know your key**, the toilet will only hand it over while it's in *pairing mode* —
  **There is no "pair" button on the dashboard**; you trigger
...
- **Dryer** has speed control in this protocol —  speed 1,2,3 + stop.
