...
#include "dashboard_fonts.h"  // FONTS_CSS: sans font woff2, base64-inlined
#include "dashboard_bg.h"     // BG_LAND / BG_PORT: background image (landscape + portrait)
...
<style>
  ...
  *{box-sizing:border-box}
  ...
  body{margin:0;font-family:'sans',-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;
    color:var(--txt);
  ...
  /* Mobile/portrait gets the portrait-cropped background; desktop keeps the landscape one. */
...
// Fault catalog: error number -> [service code, type, fix]. The firmware publishes the active error NUMBERS as CSV.
var FD = {
